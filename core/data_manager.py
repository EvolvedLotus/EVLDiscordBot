            ...
            try:
                ...
                if dtype == "config":
                    ...
                    guild_data = {
                        ...
                        'log_channel_id': save_data.get('log_channel_id'),
                        'welcome_channel_id': save_data.get('welcome_channel_id'),
                    ...
                    for embed_id, embed_data in embeds_data.items():
                        self.admin_client.table('embeds').upsert({
                            ...
                            'thumbnail': embed_data.get('thumbnail') or embed_data.get('thumbnail_url'),
                            'image': embed_data.get('image') or embed_data.get('image_url'),
