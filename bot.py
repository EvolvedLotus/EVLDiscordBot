...
async def run_bot():
    ...
    try:
        ...
        try:
            ...
            shared_secret = os.getenv('JWT_SECRET_KEY', os.getenv('SECRET_KEY', 'dev-secret-key-change-me'))
            bot.ad_claim_manager = AdClaimManager(data_manager, bot.transaction_manager, secret_key=shared_secret)
